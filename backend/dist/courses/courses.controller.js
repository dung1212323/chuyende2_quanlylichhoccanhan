...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Lấy danh sách môn học (phân trang)' }),
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Thêm môn học mới' }),
    __param(0, (0, get_user_decorator_1.GetUser)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Xoá môn học' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, get_user_decorator_1.GetUser)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number]),
